...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{output/fig_gpr_indices.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.7\textwidth]{output/fig_correlation_matrix.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{output/fig_h1_lag_selection.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{output/fig_h1_baseline.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{output/fig_h1_robust1_unrate.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{output/fig_h1_robust2_unrate_vix.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{output/fig_h1_comparison.png}
...
\noindent\textbf{Conclusion.} The output contraction half of the cost-push signature is confirmed: GPR shocks produce a statistically significant decline in industrial production at horizons $h = 6$--$36$, robust across specifications. However, the inflation half (CPI $\uparrow$) is not significant in the baseline reduced-form LP. This motivates Stage~4 (channel analysis): conditioning on specific transmission channels --- particularly oil and commodity prices --- may reveal a positive CPI effect that is masked in the total reduced-form response by the Fed's monetary-policy offset.
